...
CREATE TABLE `ad_metrics` (
  ...
  `ctr` decimal(6,2) DEFAULT 0.00,
  `leads_count` int DEFAULT 0,
  `campaign_id` bigint DEFAULT NULL,
  `workspace_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_ad_metrics_ws_camp_date` (`workspace_id`, `campaign_id`, `date`),
  KEY `idx_ad_metrics_ws_date` (`workspace_id`, `date`),
...
CREATE TABLE `leads` (
  ...
  `status` varchar(50) DEFAULT NULL,
  `external_lead_id` varchar(64) DEFAULT NULL,
  ...
  `workspace_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_ext_lead` (`workspace_id`, `external_lead_id`),

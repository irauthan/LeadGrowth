...
export default function Auth() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-slate-50 font-sans selection:bg-blue-600 selection:text-white flex flex-col justify-between items-center p-4 sm:p-8">
      ...
      {/* CENTERED CARD */}
      <div className="relative z-10 w-full max-w-md my-auto space-y-6 bg-white p-8 sm:p-10 rounded-3xl border border-slate-200/80 shadow-xl shadow-slate-200/50">
        
        {/* Hoossh Logo & Header Title */}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-4 text-xs font-medium text-slate-900 outline-none focus:border-blue-600 focus:bg-white transition-all"
                />
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-4 text-xs font-medium text-slate-900 outline-none focus:border-blue-600 focus:bg-white disabled:opacity-60"
                    />
                  </div>
                </div>
      ...
      <div className="relative z-10 my-4 text-center space-y-2">
        ...
        <div className="text-[11px] text-slate-400 font-medium">
          © 2026 Hoossh Lead Growth CRM. All rights reserved.
        </div>
      </div>

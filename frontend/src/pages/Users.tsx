      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-theme-card border border-theme-border rounded-3xl p-5 shadow-xl">
        ...
        <div className="flex gap-2">
          {isAdmin && (
            <Link
              to="/admin/users"
              className="flex items-center gap-1.5 rounded-2xl bg-theme-primary hover:bg-theme-primary-hover text-white px-4 py-2.5 text-xs font-bold shadow-lg shadow-theme-primary/10"
            >
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-2xl bg-theme-bg-alt border border-theme-border hover:bg-theme-bg text-theme-text px-4 py-2.5 text-xs font-bold transition-all"
          >
            <UserPlus size={14} />
            Invite Member
          </button>
          ...
          return (
            <div key={item.id} className="rounded-3xl border border-theme-border bg-theme-card p-6 shadow-xl space-y-4 flex flex-col justify-between hover:border-theme-primary/30 transition-all">
              <div className="space-y-4">
                {/* Header info */}
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-theme-primary/10 text-theme-primary font-extrabold text-base border border-theme-primary/20 relative">
